output "service_id" {
  ...
  value       = azurerm_api_management.apim-service.id
}

output "gateway_url" {
  description = "The URL of the Gateway for the API Management Service"
  value       = azurerm_api_management.apim-service.gateway_url
}

output "service_public_ip_addresses" {
  description = "The Public IP addresses of the API Management Service"
  value       = azurerm_api_management.apim-service.public_ip_addresses
}
...
output "product_api_ids" {
  ...
  value       = azurerm_api_management_product_api.product-api.id
}

output "product_group_ids" {
  description = "The ID of the Product/Group association created"
  value       = azurerm_api_management_product_group.product-group.id
}